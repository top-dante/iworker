                        ...
                        <a-menu mode="inline"
                            ...
                            <a-sub-menu v-for="item in team" :key="item.id">
                                <template #title>
                                    <a-avatar
                                            :src="item.avatar"
                                            class="border"/> {{item.name}}</template>
...
<script>
    ...
    import {PlusOutlined,TeamOutlined,SisternodeOutlined} from '@ant-design/icons-vue'
    export default {
        name: "Index",
        components:{
            Header,
        ...
        data(){
            return {
                openKeys:[1],
                team:[
                    {id:1,name:'普洱市简瑞科技有限公司',avatar:'http://static.jworker.pe666.cn/assets/brand/jr_logo.jpg'
                        ,children:[
                            {id:1,title:'行政部'},
                            {id:2,title:'设计部'},
                            {id:3,title:'销售部'},
                    ...
                    {id:2,name:'普洱万维广告有限公司',avatar:'http://static.jworker.pe666.cn/assets/brand/ww_logo.jpg',
                        children:[
                            {id:5,title:'行政部'},
                            {id:6,title:'设计部'},
                            {id:8,title:'销售部'},
